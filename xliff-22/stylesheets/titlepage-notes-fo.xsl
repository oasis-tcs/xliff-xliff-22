...
<xsl:template name="article.titlepage.recto">
  <xsl:choose>
    <xsl:when test="articleinfo/title">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/title[not(normalize-space(@condition) and                        not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="artheader/title">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/title[not(normalize-space(@condition) and                        not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="info/title">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/title[not(normalize-space(@condition) and                        not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="title[not(normalize-space(@condition) and                        not(contains(@condition,'oasis')))]"/>
    </xsl:when>
  </xsl:choose>

  <xsl:choose>
    <xsl:when test="articleinfo/subtitle">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/subtitle[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="artheader/subtitle">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/subtitle[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="info/subtitle">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/subtitle[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
    </xsl:when>
    <xsl:when test="subtitle">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="subtitle[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
    </xsl:when>
  </xsl:choose>

  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/pubdate[not(normalize-space(@condition) and                                not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/pubdate[not(normalize-space(@condition) and                                not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/pubdate[not(normalize-space(@condition) and                                not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/productname[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/productname[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/productname[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'namespaces' and                                               @role != 'track' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/authorgroup[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/authorgroup[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/authorgroup[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'additional']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'additional']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'additional']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'related']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'related']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'related']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'namespaces']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'namespaces']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'namespaces']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [not(@role) or (@role != 'status' and                                               @role != 'related' and                                               @role != 'additional' and                                               @role != 'notices' and                                               @role != 'citation' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/abstract[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/abstract[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/abstract[not(normalize-space(@condition) and                                 not(contains(@condition,'oasis')))]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'status']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'status']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'status']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'citation']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'citation']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'citation']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'notices']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'notices']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(normalize-space(@condition) and                                    not(contains(@condition,'oasis')))]                               [@role = 'notices']"/>
</xsl:template>
...
<xsl:template name="article.titlepage">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="{$title.fontset}">
    ...
    <xsl:if test="(normalize-space($recto.content) != '') or ($recto.elements.count &gt; 0)">
      <fo:block start-indent="0pt" text-align="start"><xsl:copy-of select="$recto.content"/></fo:block>
    </xsl:if>
